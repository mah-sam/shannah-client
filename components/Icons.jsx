...
export const ChevronLeft = (props) => (
  <Icon {...props} name="chevronLeft" pack="assets" />
);

export const EyeIcon = (props) => <Icon {...props} name="eye" pack="assets" />;

export const EyeOffIcon = (props) => (
  <Icon {...props} name="eyeOff" pack="assets" />
);

export const SearchIcon = (props) => (
  <Icon {...props} name="search" pack="assets" />
);

export const HeartRoundedIcon = (props) => (
  <Icon {...props} name="heartRounded" pack="assets" />
);

export const MarkerPinIcon = (props) => (
  <Icon {...props} name="markerPin" pack="assets" />
);

export const ChevronDownIcon = (props) => (
  <Icon {...props} name="chevronDown" pack="assets" />
);

export const FilterFunnelIcon = (props) => (
  <Icon {...props} name="filterFunnel" pack="assets" />
);

export const ArrowDropdownIcon = (props) => (
  <Icon {...props} name="arrowDropdown" pack="assets" />
);
...
export const ClockIcon = (props) => (
  <Icon {...props} name="clock" pack="assets" />
);

export const DistanceIcon = (props) => (
  <Icon {...props} name="distance" pack="assets" />
);

export const SarIcon = (props) => <Icon {...props} name="sar" pack="assets" />;

export const ArrowRightIcon = (props) => (
  <Icon {...props} name="arrowRight" pack="assets" />
);

export const PlusCircleIcon = (props) => (
  <Icon {...props} name="plusCircle" pack="assets" />
);

export const MinusCircleIcon = (props) => (
  <Icon {...props} name="minusCircle" pack="assets" />
);

export const TrashIcon = (props) => (
  <Icon {...props} name="trash" pack="assets" />
);
...
export const MinusIcon = (props) => (
  <Icon {...props} name="minus" pack="assets" />
);
